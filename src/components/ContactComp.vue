  ...
  <div class="contact">
    ...
    <div class="container">
        <div class="info">
            ...
            <h6>Leave your contact information here 👉</h6>
            ...
            <div class="socials">
                <h6>You can find and follow me on:</h6>
                ...
                <div class="icons">
                    ...
                    <a href="https://github.com/Abenathi201" target="_blank">
        ...
        <form action="https://formspree.io/f/xoqzrooq" method="POST">
            <div class="form-row">
